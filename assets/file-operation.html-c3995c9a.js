import{_ as n,Q as e,S as s,a3 as a}from"./framework-2ed98ecf.js";const i={},d=a(`<h2 id="cp" tabindex="-1"><a class="header-anchor" href="#cp" aria-hidden="true">#</a> cp</h2><p><code>cp</code>命令用于将文件（或目录）拷贝到目的地。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 拷贝单个文件</span>
