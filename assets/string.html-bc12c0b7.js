import{_ as a,Q as s,S as n,a3 as e}from"./framework-e3ca42fb.js";const l={},o=e(`<p>本章介绍 Bash 字符串操作的语法。</p><h2 id="字符串的长度" tabindex="-1"><a class="header-anchor" href="#字符串的长度" aria-hidden="true">#</a> 字符串的长度</h2><p>获取字符串长度的语法如下。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token variable">\${<span class="token operator">#</span>varname}</span>
